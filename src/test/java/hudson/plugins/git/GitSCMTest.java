...
//        FreeStyleProject project = setupProject("master", true, false);
    ...
    public void testMerge() throws Exception {
        ...
        GitSCM scm = new GitSCM(
                ...
                null, null,
                Collections.<GitSCMExtension>emptyList());
        scm.getExtensions().add(new PreBuildMerge(new UserMergeOptions("origin", "integration", "default", MergeCommand.GitPluginFastForwardMode.FF, false)));
        project.setScm(scm);
    ...
    public void testMergeFailed() throws Exception {
        ...
        GitSCM scm = new GitSCM(
                ...
                Collections.<GitSCMExtension>emptyList());
        project.setScm(scm);
        scm.getExtensions().add(new PreBuildMerge(new UserMergeOptions("origin", "integration", "", MergeCommand.GitPluginFastForwardMode.FF, false)));
    ...
    public void testMultipleMergeFailed() throws Exception {
    	...
    	GitSCM scm = new GitSCM(
    			...
    			Collections.<GitSCMExtension>emptyList());
    	project.setScm(scm);
	scm.getExtensions().add(new PreBuildMerge(new UserMergeOptions("origin", "integration1", "", MergeCommand.GitPluginFastForwardMode.FF, false)));
	scm.getExtensions().add(new PreBuildMerge(new UserMergeOptions("origin", "integration2", "", MergeCommand.GitPluginFastForwardMode.FF, false)));
